...
<div class="site-content">
        ...
        <div class="container">
            ...
            <div class="main-navigation">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item"><a href="watertmp.php">Water Temperature</a></li>
                </ul> <!-- .menu -->
            </div> <!-- .main-navigation -->
    ...
    <script>
        ...
        function updateChart(newTimestamp, newHumidity) {
            ...
            if (humidityChart.data.labels.length > 50) {
                humidityChart.data.labels.shift(); // Remove the first (oldest) label
                humidityChart.data.datasets[0].data.shift(); // Remove the first (oldest) data point
            }
        ...
        // updateChart("2024-12-28 12:30", 60);
    </script>
