        ...
        <div class="container">
            ...
            <div class="main-navigation">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item current-menu-item"><a href="water-level.html">Water Level</a></li>
                    <li class="menu-item"><a href="temp.html">Temperature</a></li>
                    <li class="menu-item"><a href="humidity.html">Humidity</a></li>
                    <li class="menu-item"><a href="water-temp.html">Underwater Temperature</a></li>
                </ul> <!-- .menu -->
            </div> <!-- .main-navigation -->
